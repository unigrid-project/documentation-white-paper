...
\node (dba-slice2) [cylinder, shape border rotate=90, draw,
    ...
    above=-0.5pt of dba-slice1.before top, anchor=after bottom, fill=green!8] {B1};
\node (dba-slice3) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dba-slice2.before top, anchor=after bottom, fill=green!12] {C1};
\node (dba-slice4) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dba-slice3.before top, anchor=after bottom, fill=red!16,dashed] {Dp};
\node (dba-slice5) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dba-slice4.before top, anchor=after bottom, fill=red!20,dashed] {Eq};
\end{scope}
...
\node (dbb-slice2) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dbb-slice1.before top, anchor=after bottom, fill=green!8] {B2};
\node (dbb-slice3) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dbb-slice2.before top, anchor=after bottom, fill=red!12,dashed] {Cp};
\node (dbb-slice4) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dbb-slice3.before top, anchor=after bottom, fill=red!16,dashed] {Dq};
\node (dbb-slice5) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dbb-slice4.before top, anchor=after bottom, fill=green!20] {E1};
\end{scope}
...
\node (dbc-slice2) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dbc-slice1.before top, anchor=after bottom, fill=red!8,dashed] {Bp};
\node (dbc-slice3) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dbc-slice2.before top, anchor=after bottom, fill=red!12,dashed] {Cq};
\node (dbc-slice4) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dbc-slice3.before top, anchor=after bottom, fill=green!16] {D1};
\node (dbc-slice5) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dbc-slice4.before top, anchor=after bottom, fill=green!20] {E2};
\end{scope}

 \begin{scope}[xshift=4.5cm]]
\node (dbd-slice1) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm, fill=red!4,dashed] {Ap};
\node (dbd-slice2) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dbd-slice1.before top, anchor=after bottom, fill=red!8,dashed] {Bq};
\node (dbd-slice3) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dbd-slice2.before top, anchor=after bottom, fill=green!12] {C2};
\node (dbd-slice4) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dbd-slice3.before top, anchor=after bottom, fill=green!16] {D2};
\node (dbd-slice5) [cylinder, shape border rotate=90, draw,
    minimum height=0.1cm,minimum width=1.2cm,
    above=-0.5pt of dbd-slice4.before top, anchor=after bottom, fill=green!20] {E3};
\end{scope}

 \begin{scope}[xshift=6cm]]
\node (dbe-slice1) [cylinder, shape border rotate=90, draw,
    minimum height=1cm,minimum width=1.2cm, fill=red!4,dashed] {Aq};
\node (dbe-slice2) [cylinder, shape border rotate=90, draw,
    minimum height=1cm,minimum width=1.2cm,
    above=-0.5pt of dbe-slice1.before top, anchor=after bottom, fill=green!8] {B3};
\node (dbe-slice3) [cylinder, shape border rotate=90, draw,
    minimum height=1cm,minimum width=1.2cm,
    above=-0.5pt of dbe-slice2.before top, anchor=after bottom, fill=green!12] {C3};
\node (dbe-slice4) [cylinder, shape border rotate=90, draw,
    minimum height=1cm,minimum width=1.2cm,
    above=-0.5pt of dbe-slice3.before top, anchor=after bottom, fill=green!16] {D3};
\node (dbe-slice5) [cylinder, shape border rotate=90, draw,
    minimum height=1cm,minimum width=1.2cm,
    above=-0.5pt of dbe-slice4.before top, anchor=after bottom, fill=red!20,dashed] {Ep};
\end{scope}
\end{tikzpicture}
\caption{A visualization of data being stored on the Unigrid network. This example is sharding data over five blockchains, of which two are used for parity and error correction. In the example, parity blocks are denoted within dashed cylinders with \emph{p} and \emph{q}, while actual data is numbered 1-3.}
\label{fig:striping}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[baseline,remember picture, scale=0.9]
		\begin{axis}[ymin=0.1,yticklabel style={
			...
			\addplot[domain=8:100,color=red,dashed] {0.3 - pow(x, 2) / 5000 * 0.2};
			\addplot[domain=8:100,color=violet,dotted] {0.3 - pow(x, 2) / 5000 * 0.45};
			\addlegendentry{0.20};
			\addlegendentry{0.30};
			\addlegendentry{0.45};
		\end{axis} 
