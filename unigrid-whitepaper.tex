...
When the network looks for confirmation on a \gls{gridnode} reward, the transaction ledger is referenced to check if there is coverage for the work that specific block contains.
...
\begin{bytefield}[bitwidth=1.08em]{32}
	...
	\bitbox{24}{owner}
	\colorbitbox{lightgray}{8}{reserved} \\
	\wordbox[lrt]{1}{null terminated domain name string} \\
	\skippedwords \\
	\wordbox[lrb]{1}{}
\end{bytefield}
\label{block:vote}
